...
function CountBox({ text }: { readonly text: number }) {
  ...
  return (
    <div className="border-input placeholder:text-muted-foreground flex h-9 w-full items-center justify-center rounded-md border bg-transparent px-3 py-1 text-sm shadow-sm transition-colors file:border-0 file:bg-transparent file:text-sm file:font-medium focus-visible:outline-none">
